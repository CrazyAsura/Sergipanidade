    ...
    <div className="space-y-24 animate-in fade-in duration-700">
      ...
      <section className="relative rounded-[3rem] overflow-hidden bg-linear-to-br from-slate-900 via-slate-800 to-slate-900 p-16 md:p-24 text-white">
        ...
        <div className="relative z-10 max-w-3xl">
          <span className="inline-block px-4 py-1.5 bg-primary text-white text-[10px] font-black uppercase tracking-widest rounded-full mb-8">Sobre a Plataforma</span>
          <h1 className="text-5xl md:text-7xl font-black leading-tight tracking-tighter uppercase italic mb-8">
            Descobrindo a <span className="text-accent">alma</span> do menor estado do Brasil.
          </h1>
          ...
          <div className="flex gap-4">
            <Button onClick={() => router.push('/auth/register')} className="bg-primary hover:bg-primary/90 text-white font-black h-14 px-10 rounded-2xl shadow-xl">
        ...
        {stats.map((s, i) => (
          <motion.div key={i} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.1 }}>
            <div className="text-center space-y-2 p-8 rounded-[2rem] bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 hover:shadow-xl transition-shadow">
              <p className="text-5xl font-black text-primary tracking-tighter">{s.value}</p>
      ...
      <section className="space-y-12">
        <div className="text-center max-w-2xl mx-auto space-y-4">
          <span className="text-[10px] font-black text-primary uppercase tracking-widest">Nossos Pilares</span>
      ...
      {/* Mission Card */}
      <section className="bg-primary rounded-[3rem] p-16 md:p-24 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center space-y-8">
          ...
          <p className="opacity-80 text-lg font-medium max-w-xl mx-auto">Nossa missão é revelar ao mundo que o menor estado é, na verdade, gigante quando o assunto é cultura, natureza e calor humano.</p>
          <Button onClick={() => router.push('/locations')} className="bg-white text-primary hover:bg-gray-50 font-black h-16 px-12 rounded-2xl shadow-2xl text-lg">
            EXPLORAR DESTINOS
          </Button>
        </div>
      </section>
      ...
      <section className="space-y-12 pb-12">
        <div className="text-center space-y-4">
          <span className="text-[10px] font-black text-primary uppercase tracking-widest">Quem Somos</span>
